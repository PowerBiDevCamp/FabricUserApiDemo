...
namespace FabricUserApiDemo.Services {
  ...
  public class FabricUserApi2 {
    ...
    private static string ExecutePostRequest(string endpoint, string postBody = "") {
      ...
      switch (response.StatusCode) {
        ...
        case HttpStatusCode.Accepted:
          ...
          // create variables that can be used inside and after do loop
          string jsonOperation;
          FabricOperation operation;
    ...
    public static FabricWorkspace UpdateWorkspace(string WorkspaceId, string WorkspaceName, string Description) {
